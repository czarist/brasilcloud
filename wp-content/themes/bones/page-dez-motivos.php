                                ...
                                <div class="container">
                                    <div class="row min-h-section justify-content-center align-items-center">
                                        <div class="col-12 text-center">
                                            <div data-aos="flip-up" data-aos-duration="1000" class="mb-5">
                                            ...
                                            <div class="swiper3 position-relative">
                                                <div class="swiper-wrapper mb-5">
                                                    ...
                                                    ?>
                                                            <div data-aos="fade-up" data-aos-duration="<?= $count ?>" class="swiper-slide row justify-content-center align-items-center bloco-infra position-relative">
